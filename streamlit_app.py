...
st.markdown("This explanation visualizes the contribution of each input feature to the model's prediction. Positive contributions move the prediction toward the predicted class, while negative contributions move it away. The magnitude of each contribution indicates its relative influence on the model's decision.")
